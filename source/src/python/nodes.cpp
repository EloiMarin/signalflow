#include "signalflow/python/python.h"
    ...
    py::class_<Rave, Node, NodeRefTemplate<Rave>>(m, "Rave", "Rave model generator")
        .def(py::init<std::string, std::string, int>(), "path"_a = "", "method"_a = "forward", "buffer_size"_a = 4096);
